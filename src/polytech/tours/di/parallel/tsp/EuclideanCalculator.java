...
public class EuclideanCalculator
{
     ...
     *
     * @param cx1 the coordinates on the x axis of point 1
     * @param cy1 the coordinates on the y axis of point 1
     * @param cx2 the coordinates on the x axis of point 2
     * @param cy2 the coordinates on the y axis of point 2
